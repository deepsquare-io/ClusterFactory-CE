...
ClusterFactory DE is a Kubernetes-based infrastructure orchestrator. ClusterFactory brings together best-in-class solutions from the HPC, Cloud, and DevOps industries to manage a cluster in a declarative way in combination with the GitOps practice.
...
If you'd like to try ClusterFactory DE, you should start by reading our [Quick Start Guide](https://docs.clusterfactory.io/docs/getting-started/requirements-recommendations) and our [documentation](https://docs.clusterfactory.io/docs/overview/welcome)!
...
We welcome your help in building ClusterFactory DE! If you are interested, we invite you to check
...
This is why we are developing ClusterFactory DE:
